...
import exceptions.XmlElementNotFound;
...
public class ParserXML {
    ...
    public ParserXML(String presentationXmlPath) throws InvalidPathException {
        if (this.validateExtension(presentationXmlPath))
        {
            ...
            logger.info("Path valid; XML loaded...");
        } else {
    ...
    public Boolean validateExtension(String path) {
        ...
        if(path.lastIndexOf(".") != -1 && path.lastIndexOf(".") != 0) {
            ...
            if ((extention).equals("xml")) validated = true;
            else logger.warn("File Extension " + extention + " not accepted");
        }
        return validated;
    }
}