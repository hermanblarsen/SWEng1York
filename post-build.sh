...
ssh -i  bscftp@ssh.amriksadhra.com 'killall screen | rm -rf /home/bscftp/CircleBuilds/ | exit'
...
ssh -i  bscftp@ssh.amriksadhra.com 'screen -m -d java -jar /home/bscftp/CircleBuilds/*.jar'
